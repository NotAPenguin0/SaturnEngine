...
void ImGui::ShowDemoWindow(bool* p_open) {
    ...
    if (ImGui::CollapsingHeader("Configuration")) {
        ...
        if (ImGui::TreeNode("Capture/Logging")) {
            ...
            HelpMarker("Try opening any of the contents below in this window "
...
static void ShowDemoWindowWidgets() {
    ...
    if (ImGui::TreeNode("Basic")) {
...

        {
            ...
            HelpMarker("USER:\nHold SHIFT or use mouse to select text.\n"
                       ...
                       "need to wire InputText() to a dynamic string type. See "
...

        {
            ...
            const char* current_element_name =
                (current_element >= 0 && current_element < Element_COUNT)
                    ...
                    : "Unknown";
            ImGui::SliderInt("slider enum", &current_element, 0,
                             Element_COUNT - 1, current_element_name);
            ImGui::SameLine();
    ...
    if (ImGui::TreeNode("Images")) {
        ...
        // pointer. The imgui_impl_opengl3.cpp renderer expect a GLuint OpenGL
    ...
    if (ImGui::TreeNode("Text Input")) {
        ...
        if (ImGui::TreeNode("Resize Callback")) {
            ...
            // using std::string.
            HelpMarker("Demonstrate using ImGuiInputTextFlags_CallbackResize "
                       "to wire your resizable string type to "
    ...
    // (see "Wiki->Useful Widgets", or github.com/ocornut/imgui/issues/2747)
    ...
    if (ImGui::TreeNode("Color/Picker Widgets")) {
        ...
        HelpMarker("ColorEdit defaults to displaying RGB inputs if you don't "
                   "specify a display mode, but the user can change it with a "
                   "right-click.\n\nColorPicker defaults to displaying "
                   "RGB+HSV+Hex if you don't specify a display mode.\n\nYou "
                   "can change the defaults using SetColorEditOptions().");
        ImGui::Combo(
    ...
    if (ImGui::CollapsingHeader("Inputs, Navigation & Focus")) {
        ...
        if (ImGui::TreeNode("Dragging")) {
            ...
            ImGui::Text("GetMouseDragDelta(0):\n  w/ default threshold: (%.1f, "
                        ...
                        value_with_lock_threshold.y, value_raw.x, value_raw.y,
        ...
        if (ImGui::TreeNode("Mouse cursors")) {
            ...
            HelpMarker("Your application can render a different mouse cursor "
                       "based on what ImGui::GetMouseCursor() returns. If "
                       "software cursor rendering (io.MouseDrawCursor) is set "
                       "ImGui will draw the right cursor for you, otherwise "
...
void ImGui::ShowAboutWindow(bool* p_open) {
    ...
    if (show_config_info) {
        ...
        if (copy_to_clipboard) {
            ImGui::LogToClipboard();
            ImGui::LogText(
                "```\n"); // Back quotes will make the text appears without
                          // formatting when pasting to GitHub
        }
...
void ImGui::ShowStyleEditor(ImGuiStyle* ref) {
    ...
    HelpMarker("Save/Revert in local non-persistent storage. Default Colors "
               "definition are not affected. Use \"Export Colors\" below to "
               "save them somewhere.");
    ...
    if (ImGui::BeginTabBar("##tabs", ImGuiTabBarFlags_None)) {
        ...
        if (ImGui::BeginTabItem("Fonts")) {
            ...
            HelpMarker("Read FAQ and misc/fonts/README.txt for details on font "
                       "loading.");
        ...
        if (ImGui::BeginTabItem("BG/FG draw lists")) {
            ...
            if (draw_bg)
                ImGui::GetBackgroundDrawList()->AddCircle(
                    ...
                    IM_COL32(255, 0, 0, 200), 48, 10 + 4);
            if (draw_fg)
                ImGui::GetForegroundDrawList()->AddCircle(
                    window_center, window_size.y * 0.6f,
                    IM_COL32(0, 255, 0, 200), 48, 10);
            ImGui::EndTabItem();
        }
